...
HD_PWD='C:/Users/danie/project_666/project_666.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log traffic_controller.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source traffic_controller.tcl -notrace
